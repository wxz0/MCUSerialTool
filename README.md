...
MCUTool是一个基于PySide6的串口工具，支持普通串口通信和Modbus RTU协议，后续将会不断更新其他协议和功能，致力于方便每一位电子工程师。
...
| 版本 |  日期 | 说明 |
|------|-------|------|
|2.1.3|2026-4-9|完善modbus rtu相关读写功能,加入蓝牙功能(尚未完善)|
|2.0.2|2026-3-26|调整布局，使其更加美观合理|
| 2.0.1| 2026-03-13| 调整组件布局|
| 2.0 |  2026-03-12| 重构为模块化设计，提高代码可维护性 |
| 1.0 |  原始版本   | 单类设计 |
